...
\begin{teorema}
    Si $p_n(x) \sim F(T)$, entonces para todo $q(x) \in \poly$ y toda $H(T) \in \F$ se tiene que $\langle H(T) | q(\mathbf{p(x)}) \rangle = \langle H(F^{-1}(T)) | q(x) \rangle $. En particular $\langle H(T) | p_n(x) \rangle = \langle H(F^{-1}(T)) | x^n \rangle $
\end{teorema}
...
\begin{corolario}
    Si $s_n(x) \sim (G(T), F(T))$, entonces para todo $q(x) \in \poly$ y toda serie formal $H(T) \in \F$ se tiene que $ \langle H(T) | q(\mathbf{s(x)}) \rangle = \langle \frac{1}{G(F^{-1}(T))}H(F^{-1}(T)) | q(x) \rangle $. En particular,  se tiene que $\langle H(T) | s_n(x) \rangle = \langle \frac{1}{G(F^{-1}(T))}H(F^{-1}(T)) | x^n \rangle $
\end{corolario}
