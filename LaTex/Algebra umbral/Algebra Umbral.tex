...
\begin{obs}
    \begin{itemize}
        ...
        \item El espacio vectorial de funcionales posee también estructura de $\field$-álgebra de forma natural, con el producto de funcionales usual. No obstante, como veremos en breve, no la utilizaremos.
    \end{itemize}
\end{obs}
...
\begin{proposicion}
    Con la topología de estabilización de $\poly^*$ y la topología formal, el i.c.u $\phi$ es un homeomorfismo.
\end{proposicion}
...
\begin{teorema}\label{topologia formal equivalente a topologia de estabilizacion}
    La topología de estabilización de $\poly^*$ se corresponde con la topología inicial del i.c.u $\phi$.
\end{teorema}
...
\end{align*}
de tal forma que, para cada $F(T) \in \F$, obtenemos el operador
\begin{align*}
