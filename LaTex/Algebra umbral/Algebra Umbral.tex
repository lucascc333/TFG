...
\begin{enumerate}
    ...
    \end{equation}
    Siguiendo la notación formal, simbolizaremos a este funcional por $E_\lambda (T) \equiv e^{\lambda T}$ y en caso de que $\lambda = 0$, se dice que $E_0$ es el \textbf{funcional aumento}. 
...
\begin{demo}
    $\Lambda$ conmuta con $E_{\lambda}(T) \iff \Lambda$ conmuta con el operador diferencia $e^{\lambda T} - 1$. Como el operador diferencia es un operador delta siempre que $\lambda \neq 0$, por el corolario anterior se concluye.   
\end{demo}
