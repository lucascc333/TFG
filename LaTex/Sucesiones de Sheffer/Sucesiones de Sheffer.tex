...
\end{align*}
para toda $G(T) \in \F$ y todo $p(x) \in \poly$. Esta observación nos permite enunciar y probar los dos siguientes teoremas clave, generalizaciones de estos hechos y muestras, una vez más, de la relación con $p_n(x) = x^n$ existente para las sucesiones de Sheffer.
