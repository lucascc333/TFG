...
\begin{align*}
    ...
    & = \sum_{k=0}^n \frac{1}{k!} \langle \frac{1}{G(F^{-1}(T))}(F^{-1}(T))^k | x^n \rangle \xi^k
\end{align*}
y por el otro $\langle \sum_{k=0}^\infty \frac{s_k(\xi)}{k!}T^k | x^n \rangle = s_n(\xi)$. Como esto es válido para cualquier $\xi$, se concluye. \qedhere
\end{demo}
...
\begin{corolario}
    ...
    \begin{equation*}
        s_n(x) = \sum_{k=0}^n \binom{n}{k} \langle \frac{1}{G(T)} | x^{n-k} \rangle x^k
    \end{equation*}
\end{corolario}
