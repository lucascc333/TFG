...
\begin{frame}{Series como operadores}
  ...
  \begin{enumerate}
    ...
    \item Con esta notación, esto se corresponde con 
      \begin{equation*}
...
\begin{frame}{Propiedades de los operadores}
  \begin{enumerate}
    \item Los operadores verifican resultados análogos a los de los funcionales.
  ...
  \begin{demo}
    Por linealidad, se reduce al caso trivial de las potencias $T^n$.
  \end{demo}
\end{frame}
